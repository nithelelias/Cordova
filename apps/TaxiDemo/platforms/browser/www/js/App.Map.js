            ...
            this.travel = {
                ...
                unset: function() {
                    ...
                    try {
                        ...
                        this.fromPlace = null;
                        this.toPlace = null;
                        _this.Google.directionsDisplay.setMap(null);
                    } catch (e) {
                ...
                geocodeLocation: function(_travePlace) {
                    _this.Google.geocoder.geocode({
                        'location': _travePlace.marker.getPosition()
                ...
                findRoute: function() {
                    if (_this.travel.route.geocodes >= 2) {
                        ...
                        _this.Google.directionsService.route({
                            ...
                            if (status === 'OK') {
                                _this.Google.directionsDisplay.setMap(getMap());
